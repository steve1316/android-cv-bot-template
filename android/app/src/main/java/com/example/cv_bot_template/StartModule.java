...
import com.example.cv_bot_template.bot.EntryPoint;
import com.example.cv_bot_template.utils.CustomJSONParser;
    ...
    public void startDiscordTest() {
        ...
        class DiscordRunner {
            ...
            public void main() {
                ...
                try {
                    api = new DiscordApiBuilder().setToken(entryPoint.getConfigData().getDiscordToken()).login().join();
                } catch (Exception e) {
                ...
                try {
                    user = api.getUserById(entryPoint.getConfigData().getDiscordUserID()).join();
                } catch (Exception e) {
