...
class NotificationUtils {
	companion object {
		...
		private const val CHANNEL_NAME: String = "Example CV Bot Template"
		private const val CONTENT_TITLE: String = "Example CV Bot Template"
		private const val CHANNEL_DESCRIPTION: String = "Displays status of Example, whether it is running or not."
		...
		fun createBotStateChangedNotification(context: Context, contentTitle: String, contentText: String) {
			...
			val channelName = "Example CV Bot Template"
